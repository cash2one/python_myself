...
browser = webdriver.PhantomJS(u"E:\python\phantomjs-1.9.7-windows\phantomjs.exe")
...
for i in range(len(item)):
    # 设置网路监控代理
    server = Server("E:\\python\\browsermob-proxy-2.0-beta-6\\bin\\browsermob-proxy.bat")
    ...
    driver = webdriver.PhantomJS(u"E:\python\phantomjs-1.9.7-windows\phantomjs.exe")
