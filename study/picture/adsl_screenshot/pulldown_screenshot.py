    ...
    def picture_screenshot_html(self, keyword, ckurl, searchDevice, spidertype, searchPage, returnType):
        ...
        try:
            if int(searchDevice) == 1:
                ...
                js = """
                    ...
                    if(products.length > 0){
                        ...
                        for(var i=0; i < overflows.length; i++){
                            if(i == 0){
                                overflows[i].setAttribute('style','border: 3px solid red;');
                                return;
                            }
                        }
                    }
                ...
                sxcapture = base64.b64decode(picture)
                file = open("%scapture.png" % 1, "wb")
...
if __name__ == "__main__":
    ...
    data = sx.picture_screenshot_html("招聘", ".51job.com", 1, 1, 5, "1111")
