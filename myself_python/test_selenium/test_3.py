...
driver = webdriver.Chrome(executable_path=u"D:\pyCharm\chromedriver.exe")
...
proxy.new_har("youku")
# 得到网页源代码
redirect_url = "http://v.youku.com/v_show/id_XOTM3Nzg2ODE2.html?from=y1.2-1-91.4.1-1.1-1-2-0-0%26source%3Dautoclick#paction"
print redirect_url
